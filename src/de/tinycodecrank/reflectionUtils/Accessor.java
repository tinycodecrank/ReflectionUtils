...
public final class Accessor<E extends AccessibleObject & Member>
{
	...
	{
		void accept(Parent parent, AccObj member, Value value) throws IllegalArgumentException, IllegalAccessException;
	}
	
	@FunctionalInterface
	public static interface AccessSupplier<Parent, AccObj, Return>
	{
		Return get(Parent parent, AccObj member) throws IllegalArgumentException, IllegalAccessException;
	}
}